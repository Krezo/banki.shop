...
import {
  Actions as PictureActions,
  Getters as PictureGetters,
  Mutations as PictureMutations,
  pictureStore,
...
const pictureStoreHelper = new StoreHelper<
  PictureMutations,
  PictureActions,
  PictureGetters,
  'picture'
>(store, 'picture');
const cartStoreHelper = new StoreHelper<CartMutations, CartActions, CartGetters, 'cart'>(
  store,
  'cart'
);
